    ...
    create(userId, productId, basketData) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = yield basket_1.default.create(Object.assign(Object.assign({}, basketData), { userId: user.id, userName: user.name, productId: product.id, productName: product.name }));
                return result;
            }
            catch (err) {
                throw err;
